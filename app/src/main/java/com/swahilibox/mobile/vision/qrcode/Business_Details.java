...
public class Business_Details extends AppCompatActivity implements View.OnClickListener{
EditText case_no, courtdate, bus_desc, cust_name, cust_phone;
    LoginDataBaseAdapter loginDataBaseAdapter;
    Button lodge;
    public static final String URL_LODGE= "http://www.fastagas.com/swahilibox/lodge_case.php";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        case_no.setText("Case No: "+caseno);
        courtdate.setText("Court Date: "+court_date);
                    ...
                    public void onResponse(String response) {
                        ...
                        if(response.contains("right"))
                        {
                            ...
                            new SweetAlertDialog(Business_Details.this, SweetAlertDialog.SUCCESS_TYPE)
                                    ...
                                    .show();
                            Intent intent = new Intent(Business_Details.this, Favs.class);
