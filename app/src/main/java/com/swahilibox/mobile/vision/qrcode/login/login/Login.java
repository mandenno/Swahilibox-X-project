...
import com.swahilibox.mobile.vision.qrcode.Favs;
...
public class Login extends AppCompatActivity implements LoginView {
    ...
    private void LoginValidation(final String username, final String password) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, "http://fastagas.com/swahilibox/user_login.php",
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        if (response.contains("success")) {
                            ...
                            Intent intent = new Intent(Login.this, Favs.class);
                          ...
                          rem_login.setVisibility(View.VISIBLE);
                            ...
                            new SweetAlertDialog(Login.this, SweetAlertDialog.WARNING_TYPE)
                                    ...
                                    .setContentText("There were too many login attempts! Kindly contact the administrator!")
                                    .setConfirmText("OK")
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        alertDialogBuilder.setMessage("Network connection problem please retry again!");
