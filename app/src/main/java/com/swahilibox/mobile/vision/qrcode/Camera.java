...
public class Camera extends AppCompatActivity {
    ...
    private TextView scanResults, b_no;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // overridePendingTransition(R.anim.fadein, R.anim.fadeout);
        ...
        b_no = (TextView) findViewById(R.id.b_no);
        b_no.setText(Camera.this.getIntent().getExtras().getString("bus_no"));
        ...
        new SweetAlertDialog(this, SweetAlertDialog.WARNING_TYPE)
                .setTitleText("TAKE PHOTO")
                .setContentText("Take a Photo of the Business Permit QR Code")
                .setCancelText("CANCEL")
                .setConfirmText("TAKE PHOTO")
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == PHOTO_REQUEST && resultCode == RESULT_OK) {
            ...
            try {
                ...
                if (detector.isOperational() && bitmap != null) {
                    ...
                    for (int index = 0; index < barcodes.size(); index++) {
                       ...
                       scanResults.setText(code.displayValue);
                        ...
                        intent.putExtra("qr_code", code.displayValue+"");
                        intent.putExtra("bus_no", Camera.this.getIntent().getExtras().getString("bus_no"));
                        startActivity(intent);
                        Toasty.success(this, "QR code verifyied...Please wait!", Toast.LENGTH_LONG).show();
                        finish();
                    ...
                    if (barcodes.size() == 0) {
                       // scanResults.setText("Scan Failed: Found nothing to scan");
                        new SweetAlertDialog(this, SweetAlertDialog.ERROR_TYPE)
                                .setTitleText("Oops...")
                                .setContentText("There is no QR code in the Snapshot! Kindly try again!")
                                .show();
                ...
                new SweetAlertDialog(this, SweetAlertDialog.ERROR_TYPE)
                        .setTitleText("Oops...")
                        .setContentText("Failed to load Image. Kindly try again!")
                        .show();
